...
let date2 = new Date(dateTo).getTime();
  if((date1<date2)||dateTo == "" ||dateFrom == ""){props.search({name:name, keywords:keywords ,ofDateFrom:dateFrom, ofDateTo:dateTo});}
  ...
  return (
    <div>
     <form className="container bg-warning mt-3 mb-2 fs-2 " onSubmit={search}><br></br>
